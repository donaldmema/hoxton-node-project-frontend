...
export function CompanyReviews(){
  ...
  useEffect(() => {
    ...
    return(
        ...
        <form className="company-search-form" onSubmit={(event) => handleSubmit(event)}>
        <input className="company-search-input" name="searchcompanies" type="search" placeholder="search" ></input>
